    ...
    internal class GCLCtrlOptionsPatcher implements LatticePatcher
    {
        ...
        private function patchRenderInfoPanel(clazz:ASClass):void
        {
                ...
                .findNext(function (instr:ASInstruction):Boolean
            {
                ...
                ASInstruction.CallProperty(ASQName(PackageInternalNs("Bezel.GCL"), "renderInfoPanel"), 2)
                );
        ...
        private function patchEnterFrame(clazz:ASClass):void
        {
                ...
                .then(function (instr:ASInstruction):void
            {
                ...
                ASInstruction.Pop(),
                ASInstruction.GetLex(ASQName(PackageInternalNs("Bezel.GCL"), "GCLSettingsHandler")),
                ASInstruction.GetProperty(ASQName(PackageInternalNs("Bezel.GCL"), "IS_CHOOSING_KEYBIND")),
                ASInstruction.Not()
                )
                .findNext(function (instr:ASInstruction):Boolean
            {
