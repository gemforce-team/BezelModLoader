package Bezel.GCCS
{
    ...
    internal class GCCSSetting
    {
        ...
        public static function makeBool(mod:String, name:String, onSet:Function, currentVal:Function, description:String):GCCSSetting
        {
            return new GCCSSetting(TYPE_BOOL, mod, name, onSet, currentVal, description);
        }

        public static function makeRange(mod:String, name:String, min:Number, max:Number, step:Number, onSet:Function, currentVal:Function, description:String):GCCSSetting
        {
            return new GCCSSetting(TYPE_RANGE, mod, name, onSet, currentVal, description, min, max, step);
        }

        public static function makeKeybind(name:String, onSet:Function, currentVal:Function, description:String):GCCSSetting
        {
            return new GCCSSetting(TYPE_KEYBIND, SettingManager.MOD_KEYBIND, name, onSet, currentVal, description);
        }

        public static function makeNumber(mod:String, name:String, min:Number, max:Number, onSet:Function, currentVal:Function, description:String):GCCSSetting
        {
            return new GCCSSetting(TYPE_NUMBER, mod, name, onSet, currentVal, description, min, max);
        }
        ...
        private function onRangeReleased(e:MouseEvent):void
        {
            ...
            this.onSet(GCCSSettingsHandler.calculateValue(this, (this.panel as McOptPanel).knob));
        }
        ...
        private function onKeybindTyped(e:KeyboardEvent):void
        {
            ...
            GCCSSettingsHandler.IS_CHOOSING_KEYBIND = false;
            ...
            for each (var key:String in GCCSSettingsHandler.KeyboardConstants)
            {
            ...
            GCCSSettingsHandler.updateButtonColors();
        }
        ...
        private function onKeybindClicked(e:MouseEvent):void
        {
            ...
            GCCSSettingsHandler.IS_CHOOSING_KEYBIND = true;
        }
