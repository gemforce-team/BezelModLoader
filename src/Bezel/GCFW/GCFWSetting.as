package Bezel.GCFW
{
    ...
    internal class GCFWSetting
    {
        ...
        public static function makeButton(mod:String, name:String, onClick:Function, description:String):GCFWSetting
        {
            return new GCFWSetting(TYPE_BUTTON, mod, name, onClick, null, description);
        }
